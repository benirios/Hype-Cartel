...
2. dotnet run --project ./MafiaStore.csproj --urls [http://127.0.0.1:5301](http://127.0.0.1:5301)
  - To run without rebuilding: dotnet run --project ./MafiaStore.csproj --no-build --urls [http://127.0.0.1:5301](http://127.0.0.1:5301)
...
- Create a migration: dotnet ef migrations add  --project ./MafiaStore.csproj
